...
@EnableMongoRepositories(basePackages = "com.techprimers.mongodb.springbootmongodbexample")
@Configuration
public class MongoDBConfig {
    ...
    CommandLineRunner commandLineRunner(UserRepository userRepository) {
        return strings -> {
            ...
            userRepository.save(new Users(2, "tes1", "Operations", 2000L));
            userRepository.save(new Users(3, "tes2", "Operations", 2000L));
            userRepository.save(new Users(4, "tes3", "Operations", 2000L));
        };
    }
